...
namespace ArrayClass
{
    internal class ArrayClass
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("The first occurence of 42 is at index" + Array.IndexOf(Arr, 42)) ;
            Console.WriteLine("The first occurence of 42 is at index" + Array.LastIndexOf(Arr, 42));
            int x = 0;
